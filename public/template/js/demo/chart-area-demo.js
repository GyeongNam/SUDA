...
var myLineChart2 = new Chart(ctx2, {
  ...
  data: {
    ...
    datasets: [{
      ...
      lineTension: 0.3,
      backgroundColor: "rgba(78, 115, 223, 0.05)",
      borderColor: "rgba(78, 223, 93, 1)",
      pointRadius: 3,
      pointBackgroundColor: "rgba(78, 223, 93, 1)",
      pointBorderColor: "rgba(78, 223, 93, 1)",
      pointHoverRadius: 3,
      pointHoverBackgroundColor: "rgba(78, 223, 93, 1)",
      pointHoverBorderColor: "rgba(78, 223, 93, 1)",
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [0, 1000, 5000, 10000, 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000],
    }],
  },
  options: {
    maintainAspectRatio: false,
